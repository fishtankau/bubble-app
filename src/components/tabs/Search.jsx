...
export default function SearchTab() {
  ...
  useEffect(() => {
    ...
    fetch('/api/omni-embed-url', {
      ...
      body: JSON.stringify({
        ...
        contentPath: brand.embedDashboardPath || '/dashboards/a73297b4',
  ...
  }, [brand.embedSecret, brand.embedDashboardPath, brand.embedVanityDomain, brand.embedSendRegionAttribute, currentUser?.externalId])
